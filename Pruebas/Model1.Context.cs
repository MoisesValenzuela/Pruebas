...
namespace Pruebas
{
    ...
    public partial class PruebaEntities : DbContext
    {
        ...
        public virtual ObjectResult<SP_MOSTRARTABLAACTIVOS_Result> SP_MOSTRARTABLAACTIVOS()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_MOSTRARTABLAACTIVOS_Result>("SP_MOSTRARTABLAACTIVOS");
        }
